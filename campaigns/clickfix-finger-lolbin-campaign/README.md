...
Up to approximately 30 days of endpoint telemetry (June 2026) surfaced 25 suspicious `finger.exe` commands shaped like ClickFix lures. Triaging all 25 revealed three distinct malware families sharing the same TCP/79 delivery vector.
